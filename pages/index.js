  ...
  return (
    <div className=''>
      ...
      <main className='max-w-7xl mx-auto px-8 sm:px-16'>
        <section className='pt-6'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {exploreData?.map((i, index) => (
              <SmallCard key={i.id} id={i.id} img={i.img} distance={i.distance} location={i.location} />
            ))}
          </div>
        </section>
          ...
          <div className='relative'>
            <div className='relative flex space-x-3 overflow-scroll scrollbar-hide p-3 -ml-3'>
              {cardsData?.map((i, index) => (
                <MediumCard searchWithTag={searchWithTag} key={index} img={i.img} title={i.title} />
              ))}
            </div>
        ...
        <LargeCard img='/greatestoutdoors.jpg' title='The Greatest Outdoors' description='Wishlists curated by Airbnb' buttonText='Get Inspired' />
