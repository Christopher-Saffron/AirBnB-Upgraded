  ...
  return (
    <div>
        ...
        <main className='flex flex-col max-w-screen-2xl min-h-screen relative  mx-auto overflow-hidden'>
          <p className='font-semibold italic text-3xl text-center my-5 text-gray-700'>Your travel history</p>
          <div className='flex flex-col gap-3 mx-auto min-h-[400px] w-full max-w-screen-lg mb-5'>
          {travels.map(travel => (
            <div key={travel._id}><HistoryItem travel={travel} /></div>
          ))}
          </div>            
        </main>
        <Footer />
