...
function Header({placeholder}) {
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-xl p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
            <input onChange={(e) => {setSearchInput(e.target.value)}} placeholder={placeholder || 'Start your search'} value={searchInput} className=' flex-grow pl-5 bg-transparent outline-none text-sm text-gray-500 placeholder-gray-400' type='text' placeholder='Start your search' />
