    ...
    <header className='sticky  top-0 z-50 bg-white mx-auto shadow-md p-5 md:px-10'>
        <div className='max-w-6xl mx-auto grid grid-cols-3'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                <input onChange={(e) => {setSearchInput(e.target.value)}} placeholder={placeholder || 'Start your search'} value={searchInput} className=' flex-grow pl-5 bg-transparent outline-none text-sm text-gray-500 placeholder-gray-400' type='text' />
            ...
            {searchInput && (
                <div className='flex flex-col col-span-3 mx-auto mt-10 headerSearch'>
                    ...
                    <div className='flex justify-center gap-5'>
                        <button onClick={resetInput} className=' text-white px-6 py-3 rounded-lg bg-red-500 bg-gradient-to-t from-red-500 to-red-300 transition duration-200 ease-out hover:scale-105'>Cancel</button>
                        <button onClick={search} className=' text-white font-bold px-6 py-3 rounded-lg bg-red-500 bg-gradient-to-t from-red-700 to-red-500 transition duration-200 ease-out hover:scale-105'>Search</button>
                    </div>
                </div>
            )}
        </div>
