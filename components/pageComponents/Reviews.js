    ...
    <div className='pt-3 px-5 mt-6 border-t border-gray-300'>
        ...
        <div className='grid mt-3 grid-cols-1 md:grid-cols-2 sm:px-3 md:px-0 gap-y-3 gap-x-12 text-sm'>
            <div className='flex justify-between'>
                ...
                <div className='flex gap-3 justify-end w-full items-center'>
                    <div className='relative  h-2 bg-gray-300 w-full max-w-[180px] lg:max-w-[200px]'>
                        <div className='bg-gray-900 absolute top-1/2 transform -translate-y-1/2 left-0 h-full' style={{width: '85%'}}/>
                    </div>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex gap-3 justify-end w-full items-center'>
                    <div className='relative  h-2 bg-gray-300 w-full  max-w-[180px] lg:max-w-[200px]'>
                        <div className='bg-gray-900 absolute top-1/2 transform -translate-y-1/2 left-0 h-full' style={{width: '99%'}}/>
                    </div>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex gap-3 justify-end w-full items-center'>
                    <div className='relative  h-2 bg-gray-300 w-full  max-w-[180px] lg:max-w-[200px]'>
                        <div className='bg-gray-900 absolute top-1/2 transform -translate-y-1/2 left-0 h-full' style={{width: '88%'}}/>
                    </div>
            ...
            <div className='flex justify-between'>
                ...
                <div className='flex gap-3 justify-end w-full items-center'>
                    <div className='relative  h-2 bg-gray-300 w-full  max-w-[180px] lg:max-w-[200px]'>
                        <div className='bg-gray-900 absolute top-1/2 transform -translate-y-1/2 left-0 h-full' style={{width: '100%'}}/>
                    </div>
                    <p className='ml-4'>5.0</p>
                </div>
            </div>
        ...
        {commentsArray.map((user,i) => (
            <div key={i} className=' w-full max-h-[200px] even:hidden md:even:block'>
                <div className='flex gap-3'>
                        <div className='h-12 w-12 relative'>
                            <Image src={user.picture.thumbnail} alt='' fill className='object-contain rounded-full' />
                        </div>
                    <div className=''>
